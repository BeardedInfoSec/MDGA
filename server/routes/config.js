...
const US_REALMS = [
  ...
  "Anub'arak",'Anvilmar','Arathor','Archimonde','Area 52','Argent Dawn','Arthas','Arygos',
  ...
  'Dalvengyr','Dark Iron','Darkspear','Darrowmere',"Dath'Remar",'Dawnbringer','Deathwing',
  'Demon Soul','Dentarg','Destromath','Dethecus','Detheroc','Doomhammer','Draenor',
  ...
  "Eldre'Thalas",'Elune','Emerald Dream','Eonar','Eredar','Executus','Exodar',
  'Farstriders','Feathermoon','Fenris','Firetree','Fizzcrank','Frostmane','Frostmourne',
  ...
  'Illidan','Jaedenar',"Jubei'Thos","Kael'thas",'Kalecgos','Kargath',"Kel'Thuzad",
  'Khadgar','Khaz Modan',"Khaz'goroth","Kil'jaeden",'Kilrogg','Kirin Tor','Korgath',
  'Korialstrasz','Kul Tiras','Laughing Skull','Lethon','Lightbringer',"Lightning's Blade",
  'Lightninghoof','Llane','Lothar','Madoran','Maelstrom','Magtheridon','Maiev',
  "Mal'Ganis",'Malfurion','Malorne','Malygos','Mannoroth','Medivh','Misha',"Mok'Nathal",
  ...
  'Ravenholdt','Rexxar','Rivendare','Runetotem','Sargeras','Saurfang','Scarlet Crusade',
  'Scilla',"Sen'jin",'Sentinels','Shadow Council','Shadowmoon','Shadowsong','Shandris',
  'Shattered Halls','Shattered Hand',"Shu'halo",'Silver Hand','Silvermoon',
  'Sisters of Elune','Skullcrusher','Skywall','Smolderthorn','Spinebreaker','Spirestone',
  'Staghelm','Steamwheedle Cartel','Stonemaul','Stormrage','Stormreaver','Stormscale',
  ...
  'Thunderhorn','Thunderlord','Tichondrius','Tol Barad','Tortheldrin','Trollbane',
  'Turalyon','Twisting Nether','Uldaman','Uldum','Undermine','Ursin','Uther','Vashj',
  "Vek'nilash",'Velen','Warsong','Whisperwind','Wildhammer','Windrunner','Winterhoof',
